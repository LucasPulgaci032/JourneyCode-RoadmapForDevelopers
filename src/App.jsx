import "./App.css";
import StartComponents from "./Pages/InitialPage/InitialPage";
import { useContext, useEffect } from "react";
import { BtnMenu, Menu } from "./Components/Menu";
import { Routes, Route, useLocation } from "react-router-dom";
import { AboutPage } from "./Pages/AboutPage/index";
import { RoadmapGeneric } from "./Pages/RoadmapLangPages/RoadmapPage";
...
function App() {
  const { menu, toggleMenu, setMenu, color } = useContext(ThemeProvider);
