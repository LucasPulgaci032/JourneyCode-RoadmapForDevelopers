    ...
    return(
      <section className="flex flex-col text-center gap-10 p-20 ">
                 ...
                 <FormLogin onSubmit ={register}>
                      <Header/>
                    <InputLogin type="text" placeholder="insira seu nome de usuário" value={name} onChange={(e)=> setName(e.target.value)} />

                     <InputLogin type="email" placeholder="insira seu email" value={email} onChange={(e)=> setEmail(e.target.value)}/>

                     <InputLogin type="password" placeholder="insira sua senha"
                      value={password} onChange={(e)=> setPassword(e.target.value)} 
                     />

                     <button className="self-start font-bold hover:scale-110 transition-transform duration-200" type="submit">Cadastrar</button> 
                     <Link  className="self-start font-bold hover:scale-110 transition-transform duration-200" to={"/"}>
